...
var Bindings = []Binding{
	// Navigation
	{ScopeMain | ScopeOverlay, []string{"up", "k"}, "↑ / k", "Move up", "Navigation", "move", 10},
	...
	{ScopeMain, []string{"/"}, "/", "Start incremental search (name, PID or user)", "Navigation", "search", 20},
	...
	// Sorting
	{ScopeMain, []string{"c"}, "c", "Sort by CPU% (descending)", "Sorting", "sort", 30},
	...
	// Display
	{ScopeMain, []string{"n"}, "n", "Open the network / ports view", "Display", "net", 40},
	...
	{ScopeMain | ScopeOverlay, []string{"?"}, "?", "Toggle this help overlay", "Display", "more", 50},
	{ScopeMain, []string{"q"}, "q", "Quit", "Display", "quit", 60},
